...
export const apiResponseSchema = z
  .object({
    ...
    error: z
      ...
      .nullable()
      .describe(
        "The error that occurred. Will be `null` when there is no error.",
      ),
    message: z
      .string()
      .describe(
    ...
    code: z
      .string()
      .describe("A code used by the frontend to show user feedback."),
    data: z
      .unknown()
      .nullable()
      .describe("Data that the user requested / error information."),
  })
    ...
    .object({
      ...
      pagination: z.object({
        ...
        next_page: z
          .number()
          .nullable()
          .describe("Next page (if there is one)."),
        prev_page: z
          .number()
          .nullable()
          .describe("Previous page (if there is one)."),
      }),
    })
