...
export default function MdxLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <div
        id="gradient"
        className="absolute bg-primary/40 w-full h-[30rem] z-0"
      >
        <div
          id="blackoverlay"
      ...
      <main className="max-w-7xl mx-auto z-10 relative px-6 pt-32">
        ...
        <div className="flex gap-4 items-center flex-wrap my-6">
          <a
            id="badge"
            className="px-6 py-2 text-xs bg-primary rounded-full text-white"
          >
            Termos legais
          </a>
        ...
        <article className="max-w-3xl grid grid-cols-1 gap-5 pb-20">
          {children}
        </article>
      </main>
    </>
