            ...
            <section className='max-w-3xl w-full pt-6 md:pt-20 text-justify flex flex-col gap-6 leading-relaxed text-sm md:text-base'>
                ...
                <p className='text-muted-foreground'>
                    ...
                    <span className='font-medium text-foreground'>
                        projeto interdisciplinar desenvolvido na FAM (Faculdade das Américas)
                    </span>
                    . Sua infraestrutura envolve diversos serviços — como o servidor da API, banco
                    de dados e sistema de cache — todos hospedados em uma{" "}
                    <span className='font-medium text-foreground'>VPS privada</span>.
                </p>

                <p className='text-muted-foreground'>
                    Como esses serviços possuem{" "}
                    <span className='font-medium text-foreground'>custos em dólar</span>, optamos
                    por mantê-los disponíveis apenas durante o período de contexto e apresentações
                    dos Projetos Integradores (PIs).
                </p>

                <p className='text-muted-foreground'>
                    Fora desses períodos, o backend é desativado para reduzir custos operacionais,
                    permanecendo apenas o frontend acessível para fins de demonstração e consulta
                    visual.
                </p>

                <p className='text-muted-foreground'>
                    Caso queira conhecer mais sobre o funcionamento do projeto, sua arquitetura e
                    principais decisões técnicas, você pode acessar a documentação ou explorar os
