...
export const AppPreview = () => {
    return (
        <motion.div
            ...
            className='p-1 lg:p-2 rounded-[1rem] lg:rounded-[2rem] border-accent border-2 relative bg-background'
        >
            <div
                id='appimage'
                className='border-border border rounded-[0.75rem] lg:rounded-[1.5rem] overflow-hidden shadow-[0_0_1rem_0_#ffffff26] relative z-[2]'
            >
            ...
            <div
                id='grid'
                className='absolute z-[1] w-full h-1/4 top-[30px] left-1/2 -translate-x-1/2 -translate-y-[100%]'
                style={{
                    maskImage:
